...
- Use environment variables or secure secret stores for credentials.
- Keep dependencies up to date; we use automated dependency checks where possible.

Thank you for helping keep NexaLayer and its users safe.
